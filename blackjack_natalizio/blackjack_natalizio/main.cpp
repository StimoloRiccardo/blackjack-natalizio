...
void run() {
    ...
    while (start == 1) {
        ...
        while (true) {
            ...
            DrawCircle(IMM2D_WIDTH / 2, 952, 58, colorefish, Black);
            
            /*sx*/
            DrawCircle(IMM2D_WIDTH / 2 - 257, 955 - 39, 50, colorefish, Black);
           
            /*centrosx*/
            DrawCircle(IMM2D_WIDTH / 2 - 138, 955 - 13, 50, colorefish, Black);
            ...
            {
                DrawImage(IMM2D_WIDTH / 2 - 60, 892, fish2[4]);
                DrawImage(IMM2D_WIDTH / 2 - 306, 955 - 90, fish2[0]);
                DrawImage(IMM2D_WIDTH / 2 - 188, 955 - 62, fish2[1]);
                DrawImage(IMM2D_WIDTH / 2 + 89, 955 - 62, fish2[3]);
                DrawImage(IMM2D_WIDTH / 2 + 207, 955 - 90, fish2[2]);
                ...
                if (partitagioc == true)
                {
                    ...
                    if (banco > giocatore && banco < 22)
                    {

                    }
                    else if (giocatore > banco && giocatore < 22)
                    {
                        saldo = saldo + (puntata * 2);
                ...
                {
                    int n = 1;
                    if (animazione[i] == true) DrawImage(xc + 30+n*30, yc, carte[i]);
                    if (animazione2[i] == true) DrawImage(xc + 35 + n * 30, yc-508, carte[i]);
                    n++;
                }
            ...
            else
            {
                ...
                {
                    DrawImage(IMM2D_WIDTH / 2 - 60, 880, fish[4]);
                }
                ...
                {
                    DrawImage(IMM2D_WIDTH / 2 - 306, 955 - 90, fish[0]);
                }
                ...
                {
                    DrawImage(IMM2D_WIDTH / 2 - 188, 955 - 62, fish[1]);
                }
                ...
                {
                    DrawImage(IMM2D_WIDTH / 2 + 89, 955 - 62, fish[3]);
                }
                if (saldo < 500)
                {
                    DrawImage(IMM2D_WIDTH / 2 + 207, 955 - 90, fish2[2]);
                ...
                {
                    DrawImage(IMM2D_WIDTH / 2 + 208, 955 - 90, fish[2]);
                }
                if (LeftMousePressed())
                {
                    int xm = MouseX();
